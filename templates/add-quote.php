<div class="adding-post__input-wrapper form__textarea-wrapper<?php if(array_key_exists("quote", $errors)): ?> form__input-section--error <?php endif; ?>">
    ...
    <div class="form__input-section">
        <textarea class="adding-post__textarea adding-post__textarea--quote form__textarea form__input" id="cite-text" name="quote" value="<?=getPostVal('quote'); ?>" placeholder="Текст цитаты"></textarea>
