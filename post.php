...
$page_content = include_template('one-post.php', ['content' => $post_content, 'post' => $active_post]);

$layout_content = include_template('layout.php', ['content' => $page_content, 'title' => $title, 'user_name' => $user_name, 'is_auth' => $is_auth]);
